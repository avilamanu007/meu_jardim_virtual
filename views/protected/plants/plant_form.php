<?php 
// views/protected/plant_form.php
// Esta view é carregada pelo PlantController::register()
...
<head>
    ...
    <title>Cadastro de Planta - Meu Jardim</title>
...
<body class="bg-green-50 min-h-screen p-4">
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">🌿 Nova Planta</h1>
            <p class="text-gray-600 mt-1">Adicione uma planta ao seu jardim</p>
        </div>
        ...
        <!-- Formulário -->
        <form action="<?= BASE_URL ?>?route=plant_register" method="POST" class="space-y-4">
